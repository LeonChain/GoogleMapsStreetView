...
function GEHelpers(ge) {
  ...
  GEHelpers.prototype.distance_w_elevres_height = function(elevres1, elevres2) {
      var loc1 = elevres1.location;
      var loc2 = elevres2.location;
      p1 = V3.latLonAltToCartesian([loc1.lat(), loc1.lng(),elevres1.elevation]);
      p2 = V3.latLonAltToCartesian([loc2.lat(), loc2.lng(),elevres2.elevation]);
      return V3.earthDistance(p1, p2);
  }
  
  GEHelpers.prototype.distance_no_height = function(loc1, loc2) {
      if (loc1.lat() == loc2.lat() && loc1.lng() == loc2.lng()) return 0.;
      p1 = V3.latLonAltToCartesian([loc1.lat(), loc1.lng(), 0]);
      p2 = V3.latLonAltToCartesian([loc2.lat(), loc2.lng(), 0]);
      return V3.earthDistance(p1, p2);
  }